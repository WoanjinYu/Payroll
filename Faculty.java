...
public class Faculty extends Employee implements  Cloneable{
    ...
    public  Faculty(String firstName, String lastName, char gender, Calendar birth, String IDNumber, FacultyLevel level, Education education){
        super(firstName, lastName, IDNumber, birth, gender);
        this.level = level;
